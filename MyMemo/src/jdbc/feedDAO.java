...
public class feedDAO {
	...
	//전체 메모 보기
	public static ArrayList<feedDTO> getAllList() throws SQLException, NamingException{
	...
	//회원 자신의 메모만 보기
	public static ArrayList<feedDTO> getOneList(String id) throws SQLException, NamingException{
