...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String  action     = "go";
        ...
        String user_id = base64Encode("difbfl4750"); // SMS아이디
        String secure = base64Encode("d7bd49c5ccca5a790d6c7a221ab3ffd0");//인증키
        ...
        String sphone2 = base64Encode("8779");
        String sphone3 = base64Encode("5395");
...
//모달로 발송성공 창 띄우기 창 제목 "SMS 발송성공" 내용 "문자메시지 발송 성공하였습니다."
//문자로 "모달테스트"
%>
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content-xl" style=" background-color: yellow;">
	      ...
	      문자메시지 발송 성공하였습니다. <br><br>
	      수신인 <br>
	       <input type="text" class="form-control" placeholder=<%=rphone1 %>>
	      발송인 <br>
                               <input type="text" class="form-control" placeholder="010-8779-5395">
...
<%response.sendRedirect("/smsExam/main.jsp?check=check"); %>
