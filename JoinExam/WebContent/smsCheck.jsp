...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String  action     = "go";
        ...
        String msg = base64Encode(nullcheck(request.getParameter("msg"), "") + "님. 회원가입을 환영합니다!");
        ...
        String join = request.getParameter("msg");

        response.sendRedirect("main.jsp?join=" + URLEncoder.encode(join));
%>