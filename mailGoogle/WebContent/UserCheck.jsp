...
<%
	...
	emailInfo.put("subject", "[구글] 회원가입을 축하합니다."); //메일 제목
	...
	//회원가입 성공시 모달 창으로 "회원가입 완료", "축하합니다."
	//회원가입 실패시 모달 창으로 "회원가입 실패", "다시 시도하세요"
...
// 	response.sendRedirect("modalTest.jsp?check=success");
%>	<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h1 class="modal-title fs-5" id="exampleModalLabel">이메일 전송 체크</h1>
...
<%	} else {
// 		response.sendRedirect("modalTest.jsp?check=fail");
%> <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
